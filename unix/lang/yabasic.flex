...
"PEEK$" return tPEEK2;
POKE return tPOKE;
FOREIGN_FUNCTION_CALL return tFGNFN_CALL;
FGNFN_CALL return tFGNFN_CALL;
"FGNFN_CALL$" return tFGNFN_CALL2;
FOREIGN_STRUCTURE_GET return tFGNBF_GET;
FGNBF_GET return tFGNBF_GET;
FOREIGN_STRUCTURE_SET return tFGNBF_SET;
FGNBF_SET return tFGNBF_SET;
"FOREIGN_STRUCTURE_NEW$" return tFGNBF_NEW;
"FGNBF_NEW$" return tFGNBF_NEW;
"FOREIGN_STRUCTURE_DUMP$" return tFGNBF_DUMP;
"FGNBF_DUMP$" return tFGNBF_DUMP;
"FOREIGN_STRUCTURE_FREE" return tFGNBF_FREE;
"FGNBF_FREE" return tFGNBF_FREE;
TOKEN return tTOKEN;
