...
"PEEK$" return tPEEK2;
POKE return tPOKE;
FOREIGN_FUNCTION_CALL return tFOREIGN_FUNCTION_CALL;
FGNFN_CALL return tFOREIGN_FUNCTION_CALL;
"FGNFN_CALL$" return tFOREIGN_FUNCTION_CALL2;
FOREIGN_STRUCTURE_GET return tFOREIGN_STRUCTURE_GET;
FGNST_GET return tFOREIGN_STRUCTURE_GET;
FOREIGN_STRUCTURE_SET return tFOREIGN_STRUCTURE_SET;
FGNST_SET return tFOREIGN_STRUCTURE_SET;
"FOREIGN_STRUCTURE_NEW$" return tFOREIGN_STRUCTURE_NEW;
"FGNST_NEW$" return tFOREIGN_STRUCTURE_NEW;
"FOREIGN_STRUCTURE_DUMP$" return tFOREIGN_STRUCTURE_DUMP;
"FGNST_DUMP$" return tFOREIGN_STRUCTURE_DUMP;
"FOREIGN_STRUCTURE_FREE" return tFOREIGN_STRUCTURE_FREE;
"FGNST_FREE" return tFOREIGN_STRUCTURE_FREE;
TOKEN return tTOKEN;
