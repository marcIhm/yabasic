***  Yabasic - A simple Basic interpreter for Unix and Windows.
  ...
  defined subroutines and Libraries. Yabasic can call out to libraries
  written in C and allows to create standalone programs. It does 
  simple graphics and printing. 
  Yabasic runs under Unix and Windows, it is small, simple, 
